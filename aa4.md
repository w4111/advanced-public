...
Go to the root of your databass codebase repository. Run `PYTHONPATH=. python test/aa4.py`. The group truth implementation of all the three test in aa4.py cost about 0.6s. If your implementation is much slower(let say 2x slower) than the ground truth implementaion, you will lose partial credits. 
